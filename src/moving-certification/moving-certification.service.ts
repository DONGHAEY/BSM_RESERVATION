...
export class MovingCertificationService {
  constructor(
    ...
    private userService: UserService, // @InjectRepository(RequestInfo)
  ...
  //   console.log('dddddd');
  //   const isRequestInfo = await this.getLastRequestBycodeAndDate(
  ...
  //   );
  //   //요청사항을 저장
  //   const { code } = await this.requestInfoRepository.save({
  ...
  // private async getLastRequestBycodeAndDate(code: number, date: Date) {
  //   return await this.requestInfoRepository.findOne({
  //     where: {
  //       entryAvailableCode: code,
  //       requestWhen: date,
  //     },
  //     order: {
  //       requestWhen: 'desc',
